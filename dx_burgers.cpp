...
int main(int argc, char *argv[]) {
    ...
    gtk_fixed_put(GTK_FIXED(fixed), wbacon_btn, 0, 50); 
    ...
    gtk_fixed_put(GTK_FIXED(fixed), wagyu_info, 200, 300); 
    ...
    gtk_fixed_put(GTK_FIXED(fixed), bistro_btn, 700, 50); 
    ...
    gtk_fixed_put(GTK_FIXED(fixed), bistro_info, 900, 50); 
